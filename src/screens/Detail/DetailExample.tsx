...
const [liked, setLiked] = useState(false);
    ...
    const toggleLike = async () => {
        try {
            ...
            await AsyncStorage.setItem(`liked_${name}`, JSON.stringify(newLikedStatus));
        } catch (error) {
    ...
    const checkLikeStatus = async () => {
        try {
            const savedLikeStatus = await AsyncStorage.getItem(`liked_${name}`);
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>    
                ...
                <Image source={liked ? require('../../assets/Heart.png') : require('../../assets/HeartLikeIcon.png')}
